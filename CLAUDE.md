...
### Chart download
The `chartName` field (e.g. `"llamacppqwen36a3bone-1.0.6.tgz"`) tells Olares what chart to install. The chart-repo-service downloads from:
```
...
|----|------|---------|---------|-------|
| `4ef430dd` | llamacppqwen36a3bone | 1.0.21 | llama.cpp b8334 | Unsloth UD-Q4_K_XL, 128.75 t/s, developer role fix |
| `2c5c39c9` | qwen36a3bvisionone | 1.0.2 | llama.cpp b8334 | UD-Q4_K_XL + mmproj F16, vision, 131.03 t/s, 16K ctx |
