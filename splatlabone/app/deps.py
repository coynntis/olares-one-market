...
MODEL_CACHE_DIR = Path(os.environ.get("SPLATLAB_MODEL_CACHE", str(DATA_DIR / "splatlab" / "cache" / "models")))
MODELSCOPE_CACHE_DIR = Path(os.environ.get("MODELSCOPE_CACHE", str(DATA_DIR / "splatlab" / "cache" / "modelscope")))
...
def ensure_dirs() -> None:
    for d in (UPLOADS_DIR, WORKSPACES_DIR, OUTPUTS_DIR, MODELS_DIR, MODEL_CACHE_DIR, MODELSCOPE_CACHE_DIR):
